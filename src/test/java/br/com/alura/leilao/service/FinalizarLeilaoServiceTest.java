...
class FinalizarLeilaoServiceTest {
	...
	void deveriaFinalizarUmLeilao() {
		...
		// Verifica se metodo salvar foi chamado com leilao como parametro
	...
	void naoDeveriaEnviarEmailParaVencedorDoLeilaoEmCasoDeErroAoEncerrarOLeilao() {
		...
		try {
			service.finalizarLeiloesExpirados();
			// Para testar em um cenario onde o teste falha, 
			// envolver o metodo leilaoDao.salvar em um try catch e deixar o
			// metodo do enviadorDeEmails apos o catch
